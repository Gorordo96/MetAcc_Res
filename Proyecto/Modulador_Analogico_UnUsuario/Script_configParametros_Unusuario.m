...
CantBit= 100;                 %Cantidad de bits a simular por cada rama del modulador OFDM                  
CantSimbOFDM=CantBit/4;       %Cantidad de simbolos OFDM
...
sim('Modulador_Analogico_UnUsuario')
figure()
